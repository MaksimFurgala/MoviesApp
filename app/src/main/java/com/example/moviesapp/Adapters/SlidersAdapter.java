...
public class SlidersAdapter extends RecyclerView.Adapter<SlidersAdapter.SliderViewholder> {
    ...
    /**
     * Объект типа runnable (кадры) для слайдера.
     */
    ...
    public SlidersAdapter.SliderViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new SliderViewholder(LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_viewholder,
                parent,
                false));
    }
    ...
    public void onBindViewHolder(@NonNull SlidersAdapter.SliderViewholder holder, int position) {
        holder.setContent(sliderItems.get(position));
    ...
    public class SliderViewholder extends RecyclerView.ViewHolder {
        ...
        /**
         * Установить контент внутрь imageView и textView
         *
         * @param sliderItems
         */
        void setContent(SliderItems sliderItems) {
